 ...
 */
namespace  App\Common\OpenWechat\Notice;
...
class Notice extends AbstractAPI
{
     ...
     * @return \EasyWeChat\Support\Collection
     */
    public function addTemplate($shortId,$appid)
    {
        $access_token = $this->auth->getAuthorizerToken($appid);
     ...
     * @return \EasyWeChat\Support\Collection
     */
    public function deletePrivateTemplate($templateId,$appid)
    {
        $access_token = $this->auth->getAuthorizerToken($appid);
     ...
     */
    public function send($data = [],$appid)
    {
        $access_token = $this->auth->getAuthorizerToken($appid);
        $params = array_merge([
                   'touser' => '',
        ...
        return $this->parseJSON('json', [self::API_SEND_NOTICE.$access_token, $params]);
    }
