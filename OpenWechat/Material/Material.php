...
class Material extends AbstractAPI
{
    ...
    const API_UPLOAD = 'https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=';
    const API_DELETE = 'https://api.weixin.qq.com/cgi-bin/material/del_material?access_token=';
