...
use App\Common\OpenWechat\User\Group;
use App\Common\OpenWechat\User\Tag;
use App\Common\OpenWechat\User\User;
...
class UserServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $pimple)
    {
        ...
        $group = function ($pimple) {
            return new Group($pimple['auth']);
        };

        $tag = function ($pimple) {
            return new Tag($pimple['auth']);
        };
